...
* _Setup instructions to re-create the database(semicolons are important!):_
  ...
  _USE hair_salon;_
  _CREATE TABLE stylists (id serial PRIMARY KEY, name VARCHAR(255), information VARCHAR(255));_
  _CREATE TABLE clients (id serial PRIMARY KEY, stylist_id INT, details VARCHAR(255));_
  _SHOW TABLES;_
